...
require (
	github.com/open-cluster-management/integrity-shield/logging v0.0.0-00010101000000-000000000000
...
replace (
	github.com/open-cluster-management/integrity-shield/logging => ../logging
